...
export default function CategoryList() {
    ...
    const categories = [
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/2085980140_IGDB-285x380.jpg',
        ...
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/509667-285x380.jpg',
            title: 'Comida y bebida',
            spectators: '2031'
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/491168_IGDB-285x380.jpg',
            title: 'Clash Royale',
            spectators: '982'
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/463447553_IGDB-285x380.jpg',
            title: 'Super Mario Bros. Wonder',
            spectators: '1776'
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/497431_IGDB-285x380.jpg',
            title: 'Skull and Bones',
            spectators: '118',
            newCategory: true
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/818770426_IGDB-285x380.jpg',
            title: 'Granblue Fantasy Versus: Rising',
            spectators: '3238',
            newCategory: true
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/41917829_IGDB-285x380.jpg',
        ...
        },
        {
            ...
            title: 'Desarrollo de software y juegos',
            spectators: '13274'
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/322503446_IGDB-285x380.jpg',
            title: 'Resident Evil 4',
            spectators: '769'
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/1540019723_IGDB-285x380.jpg',
            title: "Five Nights at Freddy's Help Wanted 2",
            spectators: '118',
            newCategory: true
        },
        {
            image: 'https://static-cdn.jtvnw.net/ttv-boxart/4931D91F85-seeklogo.com.png',
            title: 'Twitch',
            spectators: '120',
            newCategory: true
